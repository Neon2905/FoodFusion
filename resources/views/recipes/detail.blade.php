@php
    ...
    foreach ($nutritionFields as $field => $suffix) {
        if (!is_null($nutrition->$field)) {
            ...
            $nutritions[$field] = 'Not available';
        }
    }
@endphp
    ...
    <div class="flex flex-col lg:flex-row gap-4 w-full">
        ...
        <div class="flex flex-col gap-5">
            ...
            <div class="card flex-center w-full px-7 py-5" x-data="{ serving_size: {{ $recipe->servings }} }">
                ...
                @else
                    <p class="text-body-lg">No ingredients provided.</p>
                @endif
            ...
            {{-- Categories & Tips --}}
            <div x-show="@json($recipe->tags->isNotEmpty() || $recipe->tips->isNotEmpty())" class="card gap-5 w-full px-7 py-5">
                <div x-show="@json($recipe->tags->isNotEmpty())" class="flex flex-col gap-3">
                ...
                <div x-show="@json($recipe->tips->isNotEmpty())" class="flex flex-col gap-3">
            ...
            {{-- Nutrition --}}
            <div class="card flex-center gap-5 w-full px-7 py-5">
