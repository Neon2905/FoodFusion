...
@section('content')
    <div class="flex-center flex-col w-full min-h-[70vh]">
        <div class="modal-card w-full max-w-xl px-8 py-10 flex flex-col gap-6">
            ...
            <form action="{{ route('profile.setup.submit') }}" method="POST" enctype="multipart/form-data" class="flex flex-col gap-5">
                @csrf
                ...
                <div class="flex flex-col gap-2">
                    <label for="avatar" class="font-semibold text-subtitle-lg">Avatar <span class="text-muted">(optional, max 2MB)</span></label>
