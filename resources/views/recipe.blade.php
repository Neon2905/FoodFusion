...
@section('content')
    <div class="modal-card px-6 flex-1 gap-7">
        ...
        {{-- media --}}
        <img src="{{ $recipe->image }}" alt="hero-image">
        {{-- summary --}}
        ...
        <div class="flex items-center justify-between rounded-xl w-full bg-gray px-6 py-3">
            <div class="flex gap-4">
                <img class="size-23" src="{{ $recipe->author->profile_url }}" alt="profile">
                <div class="flex justify-center flex-col text-left">
                    <h2 class="text-heading-lg">By {{ $recipe->author->name }}</h2>
                    <h5 class="font-normal">{{ $recipe->author->name }}</h5>
                </div>
            </div>
        ...
        <div class="flex flex-col items-start rounded-xl w-full bg-gray px-6 py-7 gap-5">
            ...
            <form class="flex-center flex-col space-between gap-2 w-full p-3" method="POST" action="#">
                ...
                <div class="flex justify-start gap-2 w-full">
                    <img class="rounded rounded-full size-13" src="/images/profile-icons/me.png" alt="">
                    <textarea
                    ...
                    <div
                        ...
                        <div class="flex gap-3">
                            ...
                            <div class="flex flex-col">
                                <h3>
                                    {{ $review->name }} <span class="text-subtitle-md font-normal text-muted">
                                        {{-- TODO: fix later --}}
                                        {{ \Carbon\Carbon::createFromFormat('d/m/Y', $review->date)->diffForHumans() }}
                                    </span>
                                </h3>
